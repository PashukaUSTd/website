    ...
    <div class="content__top">
      <ul class="breadcrumbs">
        <li class="breadcrumbs__item">
          <a class="breadcrumbs__link" href="index.html" @click.prevent="gotoPage('main', 0)">
            Каталог
          </a>
        </li>
        <li class="breadcrumbs__item">
          <a class="breadcrumbs__link" href="#" @click.prevent="gotoPage('main', category.id)">
            {{ category.title }}
          </a>
        </li>
        <li class="breadcrumbs__item">
        ...
        <ul class="pics__list">
          <li class="pics__item">
            <a href="" class="pics__link pics__link--current">
              <img width="98" height="98" :src="product.img"
                :srcset="product.img"
                :alt="product.title"
              >
            </a>
          ...
          <li class="pics__item">
            <a href="" class="pics__link">
              <img :srcset="product.img" :alt="product.title">
            </a>
          </li>
          <li class="pics__item">
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            установить как фирменное приложение, так и различные приложения сторонних
            разработчиков. Велокомпьютер точно отслеживает местоположение, принимая
            сигнал с целого комплекса спутников. Эта информация позволяет
